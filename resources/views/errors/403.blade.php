...
<head>
    ...
    <title>403 — Akses Ditolak | PantauPangan</title>
...
<body>
    <div class="card">
        ...
        <h1>Akses Ditolak</h1>
        <p>Anda tidak memiliki izin untuk mengakses halaman ini. Pastikan Anda memiliki role yang sesuai untuk melihat konten ini.</p>
        <div>
