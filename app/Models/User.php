...
class User extends Authenticatable
{
    ...
    public function isAdminPupuk(): bool    { return $this->role === 'admin-pupuk'; }
    public function isPetani(): bool        { return $this->role === 'petani'; }
    public function isAdmin(): bool         { return in_array($this->role, ['superadmin', 'admin-komoditas', 'admin-berita', 'admin-pupuk']); }
