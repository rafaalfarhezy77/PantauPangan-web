...
if (isset($_GET['id'])) {
    ...
    // Validasi: Pastikan admin tidak tidak sengaja menghapus dirinya sendiri
    if ($id_target == $id_saya) {
        echo "<script>alert('Error: Anda tidak dapat menghapus akun Anda sendiri!'); window.location.href='dashboardAdmin.php';</script>";
        exit;
    }
