    ...
    <div id="formMasuk">
      ...
      <div class="flex gap-3">
        <button onclick="socialLogin('Google')"
          class="flex-1 flex items-center justify-center gap-2 py-2.5 bg-white border border-cream-dark rounded-xl
                 text-sm font-medium text-gray-600 hover:border-green-pale transition-colors cursor-pointer font-sans">
