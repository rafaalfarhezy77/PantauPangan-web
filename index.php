...
<nav id="navbar">
  ...
  <ul class="nav-links">
    ...
    <li><a href="#harga">Grafik Harga</a></li>
...
<div class="mobile-nav" id="mobileNav">
  <ul>
    ...
    <li><a href="#harga" onclick="closeMobileNav()"><span class="mobile-nav-icon">📊</span> Grafik Harga</a></li>
    <li><a href="#berita" onclick="closeMobileNav()"><span class="mobile-nav-icon">📰</span> Berita <span class="nav-badge">5</span></a></li>
  </ul>
  <div class="mobile-nav-divider"></div>
  <div id="mobileLoginSection">
    <a href="login.php" class="mobile-login-btn" style="text-decoration:none;display:flex;align-items:center;justify-content:center;gap:8px">👤 Masuk / Daftar</a>
  </div>
  ...
  <div class="login-modal">
    ...
    <div class="login-modal-body">
      ...
      <div id="formMasuk">
        ...
        <div class="login-forgot"><a href="#">Lupa kata sandi?</a></div>
        <button class="login-submit" onclick="doLogin()">Masuk</button>
        <div class="login-divider">atau</div>
        <button class="login-guest" onclick="doGuestLogin()">👀 Lanjut sebagai Tamu</button>
      </div>
      <!-- Form Daftar -->
...
<section id="beranda">
  ...
  <div class="hero-content">
    ...
    <div class="hero-cta">
      ...
      <a href="#harga" class="btn-outline">Lihat Grafik Harga</a>
    </div>
  ...
  <div class="search-box fade-in">
    <div class="search-row">
      <div class="search-field">
        ...
        <select class="search-input" id="searchCommodity">
          <option value="">Pilih komoditas...</option>
          <option>Beras Premium</option>
          <option>Beras Medium</option>
          <option>Jagung Pipilan</option>
          <option>Kedelai Lokal</option>
      ...
      <button class="search-btn" onclick="doSearch()">Cari Harga</button>
    </div>
    <div class="search-tags">
      <span class="search-tags-label">Populer:</span>
      <button class="tag" onclick="quickSearch('Beras Premium')">Beras</button>
      <button class="tag" onclick="quickSearch('Cabai Merah Keriting')">Cabai Merah</button>
      <button class="tag" onclick="quickSearch('Bawang Merah')">Bawang Merah</button>
      <button class="tag" onclick="quickSearch('Minyak Goreng')">Minyak Goreng</button>
      <button class="tag" onclick="quickSearch('Telur Ayam')">Telur Ayam</button>
...
<section id="harga">
  <div class="harga-header">
    <div>
      <div class="section-label">Grafik & Data</div>
      <h2 class="section-title">Pantau Pergerakan Harga</h2>
      <p class="section-subtitle" style="margin-bottom:0">Klik komoditas untuk melihat tren harga.</p>
    </div>
...
<section id="berita">
  <div class="berita-header">
    ...
    <button class="view-all-btn">Lihat Semua Berita →</button>
  </div>
...
<footer>
  ...
  <div class="footer-bottom">
    <span>© 2025 PantauPangan. Data bersumber dari Bapanas & BPS.</span>
...
<div class="modal-overlay" id="newsModal" onclick="closeModal(event)">
  <div class="modal-box">
    ...
    <button class="modal-close" onclick="document.getElementById('newsModal').classList.remove('open')">Tutup</button>
  </div>
</div>
